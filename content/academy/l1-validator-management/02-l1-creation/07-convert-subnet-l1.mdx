...
1. Convert the Subnet to an <GlossaryTerm>Avalanche L1</GlossaryTerm>
2. Add your node as a validator

Converting a Subnet to an <GlossaryTerm>Avalanche L1</GlossaryTerm> requires the Subnet owner issuing a `ConvertSubnetToL1Tx` transaction
on the <GlossaryTerm>Platform Chain</GlossaryTerm>. This transaction establishes a new validator set for your blockchain and transforms
