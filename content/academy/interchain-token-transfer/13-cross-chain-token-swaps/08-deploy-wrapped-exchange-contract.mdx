...
<Callout type="info">
  **Note:** The address `0x4Ac1d98D9cEF99EC6546dEd4Bd550b0b287aaD6D` is your receiver contract address.
</Callout>
...
Check WAVAX Balance
Since the swap involves WAVAX (the wrapped version of AVAX), use the following command to check the WAVAX token balance:
```bash
...
If you chose to receive native AVAX instead of WAVAX, check your native balance:
