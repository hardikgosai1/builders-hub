...
- **Cleanup Required**: Expired registrations must be manually removed using the [Remove Expired Validator Registration tool](/console/permissioned-l1s/remove-expired-validator-registration)
