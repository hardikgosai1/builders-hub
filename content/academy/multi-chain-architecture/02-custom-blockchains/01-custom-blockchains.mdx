...
An <GlossaryTerm>Avalanche L1</GlossaryTerm> is a sovereign network that defines its own rules for membership and token economics. It's validated by a dynamic subset of Avalanche validators working together to achieve consensus on the <GlossaryTerm>blockchain</GlossaryTerm>'s state.
...
Avalanche's three main blockchains form the <GlossaryTerm>Primary Network</GlossaryTerm>:

- <GlossaryTerm>Platform Chain</GlossaryTerm> (P-Chain)
- <GlossaryTerm>Contract Chain</GlossaryTerm> (C-Chain)
- <GlossaryTerm>Exchange Chain</GlossaryTerm> (X-Chain)
