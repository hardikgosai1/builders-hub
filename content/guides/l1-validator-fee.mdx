...
Introduced with <GlossaryTerm>ACP-77</GlossaryTerm>, [Avalanche L1 Validators](https://build.avax.network/guides/subnet-vs-l1-validators) enable the creation of sovereign L1
