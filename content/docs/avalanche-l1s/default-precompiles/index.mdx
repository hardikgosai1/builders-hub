...
- [AllowList Interface](/docs/avalanche-l1s/default-precompiles/allowlist) - A reusable interface for permission management
- [Deployer AllowList](/docs/avalanche-l1s/default-precompiles/deployerallowlist) - Control which addresses can deploy contracts
- [Native Minter](/docs/avalanche-l1s/default-precompiles/nativeminter) - Mint additional native tokens
- [Transaction AllowList](/docs/avalanche-l1s/default-precompiles/transactionallowlist) - Control which addresses can submit transactions
- [Fee Manager](/docs/avalanche-l1s/default-precompiles/feemanager) - Configure fee parameters
- [Reward Manager](/docs/avalanche-l1s/default-precompiles/rewardmanager) - Configure fee reward mechanisms
