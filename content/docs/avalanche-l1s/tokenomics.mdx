...
The Native Minter precompile uses the [AllowList interface](/docs/avalanche-l1s/default-precompiles/allowlist) to restrict access to its functionality with the following roles.
