...
Both precompiles use the [AllowList interface](/docs/avalanche-l1s/default-precompiles/allowlist) to restrict access to their functionality.
...
The FeeManager precompile uses the [AllowList interface](/docs/avalanche-l1s/default-precompiles/allowlist) to restrict access to its functionality.
