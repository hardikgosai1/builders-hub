...
Subnet-EVM comes with a set of default precompiles that extend the EVM's functionality. For detailed documentation on each precompile, visit the [Avalanche L1s Precompiles](/docs/avalanche-l1s/default-precompiles) section:

- [AllowList](/docs/avalanche-l1s/default-precompiles/allowlist): A reusable interface for permission management
- [Permissions](/docs/avalanche-l1s/default-precompiles/permissions): Control contract deployment and transaction submission
- [Tokenomics](/docs/avalanche-l1s/default-precompiles/tokenomics): Manage native token supply and minting
- [Transaction Fees](/docs/avalanche-l1s/default-precompiles/transaction-fees): Configure fee parameters and reward mechanisms
- [Warp Messenger](/docs/avalanche-l1s/default-precompiles/warpmessenger): Perform cross-chain operations
