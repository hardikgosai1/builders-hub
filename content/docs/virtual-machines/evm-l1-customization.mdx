...
Subnet-EVM comes with a set of default precompiles that extend the EVM's functionality. For detailed documentation on each precompile, visit the [Avalanche L1s Precompiles](/docs/avalanche-l1s/evm-l1-customization#precompiles) section:

- [AllowList](/docs/avalanche-l1s/allowlist): A reusable interface for permission management
- [Permissions](/docs/avalanche-l1s/permissions): Control contract deployment and transaction submission
- [Tokenomics](/docs/avalanche-l1s/tokenomics): Manage native token supply and minting
- [Transaction Fees](/docs/avalanche-l1s/transaction-fees): Configure fee parameters and reward mechanisms
- [Warp Messenger](/docs/avalanche-l1s/warpmessenger): Perform cross-chain operations
