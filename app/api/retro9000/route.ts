...
export async function POST(request: Request) {
  try {
    ...
    const fieldMapping: { [key: string]: string[] } = {
      ...
      "team_member_1_pseudonym": ["team_member_1_pseudonym"],
      ...
      "team_member_1_country": ["team_member_1_country"],
      ...
      "team_member_2_pseudonym": ["team_member_2_pseudonym"],
      ...
      "team_member_2_country": ["team_member_2_country"],
