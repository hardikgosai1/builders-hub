        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative flex items-center">
                          ...
                          <Input className="pl-10 border-gray-300" placeholder="First name" {...field} />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="relative flex items-center">
                          ...
                          <Input className="pl-10 border-gray-300" placeholder="Last name" {...field} />
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative flex items-center">
                        ...
                        <Input className="pl-10 border-gray-300" placeholder="email@example.com" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative flex items-center">
                        ...
                        <Input className="pl-10 border-gray-300" placeholder="@username" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative flex items-center">
                        ...
                        <Input className="pl-10 border-gray-300" placeholder="Project name" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative flex items-center">
                        ...
                        <Input className="pl-10 border-gray-300" placeholder="https://your-website.com" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative flex items-center">
                        ...
                        <Input className="pl-10 border-gray-300" placeholder="@projecthandle" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        <SelectItem value="validator-marketplaces">Validator Marketplaces</SelectItem>
                        <SelectItem value="virtual-machines">Virtual Machines</SelectItem>
                        <SelectItem value="wallets">Wallets</SelectItem>
                        <SelectItem value="oracles">Oracles</SelectItem>
                        <SelectItem value="interoperability-tools">Interoperability Tools</SelectItem>
                        <SelectItem value="cryptography">Cryptography</SelectItem>
                        <SelectItem value="bridges">Bridges</SelectItem>
                        <SelectItem value="explorers">Explorers</SelectItem>
                        <SelectItem value="rpcs">RPCs</SelectItem>
                        <SelectItem value="data-storage">Data Storage</SelectItem>
                        <SelectItem value="indexers">Indexers</SelectItem>
                        <SelectItem value="token-engineering">Token Engineering</SelectItem>
                        <SelectItem value="on-and-offramps">On & Offramps</SelectItem>
                        <SelectItem value="defi">DeFi</SelectItem>
                        <SelectItem value="gaming">Gaming</SelectItem>
                        <SelectItem value="rwas-institutional">RWAs/Institutional</SelectItem>
                        <SelectItem value="culture-nfts">Culture/NFTs</SelectItem>
                        <SelectItem value="enterprise">Enterprise</SelectItem>
                        <SelectItem value="exchanges-wallets">Exchanges/Wallets</SelectItem>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 mb-8">
            <div className="space-y-1 mb-6">
              ...
              <p className="text-sm text-gray-500">Tell us about your token (if applicable)</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              {form.watch("hasToken") && (
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      <FormLabel>If so, is your token live on Avalanche?</FormLabel>
                      <div className="flex items-start space-x-4">
                        <div className="flex items-center space-x-2">
                          <Checkbox
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 mb-8">
            <div className="space-y-1 mb-6">
              <h2 className="text-xl font-semibold text-gray-900">Grant Information</h2>
              <p className="text-sm text-gray-500">Tell us about your funding needs</p>
            </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Estimate the number of users/builders" className="border-gray-300" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 mb-8">
            <div className="space-y-1 mb-6">
              <h2 className="text-xl font-semibold text-gray-900">Previous Funding</h2>
              <p className="text-sm text-gray-500">Tell us about any previous funding</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              {form.watch("previousFunding") === "yes" && (
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>If so, how much?</FormLabel>
                      <FormControl>
                        <Input placeholder="Enter amount in USD" className="border-gray-300" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 mb-8">
            <div className="space-y-1 mb-6">
              ...
              <p className="text-sm text-gray-500">Tell us about your team</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-3">
                    <FormLabel>Is your team willing to KYB?</FormLabel>
                    <FormDescription className="text-xs text-gray-500">
