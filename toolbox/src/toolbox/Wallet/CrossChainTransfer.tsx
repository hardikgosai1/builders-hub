...
export default function CrossChainTransfer({
    ...
    //FIXME: move most of the logic into the viem extension
    ...
    const { pChainAddress, walletEVMAddress, coreWalletClient, fujiPublicClient } = useWalletStore()

    // Function to fetch balances from both chains
    const fetchBalances = async () => {
        if (fujiPublicClient && walletEVMAddress) {
            fujiPublicClient.getBalance({
    ...
    }, [fujiPublicClient, walletEVMAddress, pChainAddress])
