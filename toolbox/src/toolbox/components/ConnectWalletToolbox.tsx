...
const ChainSelector = () => {
    ...
    return (
        <>
            <div className="p-4 my-4 border-2 border-red-500 rounded-xl">Owen, put your chain selector here. This block is shown only if existing L1 is required.</div>
            {/* <div className="flex items-center ">
                {l1List.map(l1 => (
                    <div key={l1.id} className={`cursor-pointer mr-4 mb-4 p-2 border rounded mb-1 ${walletChainId === l1.evmChainId ? "border-blue-500 border-2 font-bold" : "border-gray-300"}`} onClick={() => setLastSelectedL1(l1.id)}>
