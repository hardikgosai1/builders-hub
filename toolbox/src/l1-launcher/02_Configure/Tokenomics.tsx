...
import { useL1LauncherWizardStore } from '../config/l1LauncherStore';
import NextPrev from "@/components/tools/common/ui/NextPrev";
import { Label } from '@radix-ui/react-label';
import TokenAllocationList from '../../../../components/tools/common/token-allocation-list/token-allocation-list';
import AllowlistPrecompileConfigurator from '../../../../components/tools/common/allowlist-precompile-configurator/allowlist-precompile-configurator';
import { useEffect } from 'react';
import { newPrivateKey } from '../../../../components/tools/common/utils/wallet';
