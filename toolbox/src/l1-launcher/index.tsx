'use client'
import { Steps, StepListType } from "../components/Steps";
import { useL1LauncherWizardStore, resetL1ManagerWizardStore } from "./config/l1LauncherStore";
import { stepList, stepGroups } from "./config/stepList";
import ToolHeader from "../../../components/tools/common/ui/ToolHeader";
        ...
        <>
            <div className="container mx-auto max-w-6xl p-8 ">
                <ToolHeader
                    ...
                    updatePath="/tools/l1-launcher"
                    updateTitle="Update L1 Launcher Tool Information"
                />
